...
import newedenfaces from '../portfolio_pictures/newedenfaces.png';
...
export default function() {
	return [
		...
		{ name: 'EVE Character Voting', thumbnail_image: newedenfaces, about: about_newedenfaces, stack: newedenfaces_stack },
...
const newedenfaces_stack = "React + Flux - Utilizes MongoDB to save and retrieve data, Socket.IO to track online visitors in real time, and Node.js to build a REST API."
...
const about_newedenfaces = "Single-page application that retrieves data from a popular online multiplayer EVE Online, and allows plays to vote for their favorite player's avatar."
